...
Latest compiled version for Windows can be found [here](https://github.com/dylbinthedev/futurerestore/releases/).
Latest compiled version for macOS can be found [here](https://github.com/dylbinthedev/futurerestore/releases/).
...
6. [Generator Auto Setter and dimentio](https://halo-michael.github.io/repo/) for iOS 13.0-14.5.1
7. 
